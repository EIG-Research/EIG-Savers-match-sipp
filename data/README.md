...
- **SIPP 2024 Wave 1** (U.S. Census Bureau): person-level public-use file. Primary input for eligibility estimates. Variables of interest include `TPTOTINC`, `TFTOTINC`, `TPEARN`, `EFSTATUS`, `EOWN_THR401`, `EOWN_IRAKEO`, `EPENSNYN`, `EINCPENS`, `EPNSPOUSE`, plus standard demographic and weight columns. Available at https://www.census.gov/sipp/.
